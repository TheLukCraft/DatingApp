import {
  ...
  animate,
  style
} from "./chunk-ODX2FE3P.js";
import {
  CommonModule,
  DOCUMENT,
  NgClass,
  isPlatformBrowser
} from "./chunk-4AVQEBXZ.js";
import {
  ApplicationRef,
...
_PositioningService.ɵfac = function PositioningService_Factory(ɵt) {
  return new (ɵt || _PositioningService)(ɵɵinject(NgZone), ɵɵinject(RendererFactory2), ɵɵinject(PLATFORM_ID));
};
...
_ComponentLoaderFactory.ɵfac = function ComponentLoaderFactory_Factory(ɵt) {
  return new (ɵt || _ComponentLoaderFactory)(ɵɵinject(ComponentFactoryResolver$1), ɵɵinject(NgZone), ɵɵinject(Injector), ɵɵinject(PositioningService), ɵɵinject(ApplicationRef), ɵɵinject(DOCUMENT));
};
...
_BsDropdownConfig.ɵfac = function BsDropdownConfig_Factory(ɵt) {
  return new (ɵt || _BsDropdownConfig)();
};
...
_BsDropdownState.ɵfac = function BsDropdownState_Factory(ɵt) {
  return new (ɵt || _BsDropdownState)();
};
...
_BsDropdownContainerComponent.ɵfac = function BsDropdownContainerComponent_Factory(ɵt) {
  return new (ɵt || _BsDropdownContainerComponent)(ɵɵdirectiveInject(BsDropdownState), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(AnimationBuilder));
};
...
_BsDropdownDirective.ɵfac = function BsDropdownDirective_Factory(ɵt) {
  return new (ɵt || _BsDropdownDirective)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ViewContainerRef), ɵɵdirectiveInject(ComponentLoaderFactory), ɵɵdirectiveInject(BsDropdownState), ɵɵdirectiveInject(BsDropdownConfig), ɵɵdirectiveInject(AnimationBuilder));
};
...
_BsDropdownMenuDirective.ɵfac = function BsDropdownMenuDirective_Factory(ɵt) {
  return new (ɵt || _BsDropdownMenuDirective)(ɵɵdirectiveInject(BsDropdownState), ɵɵdirectiveInject(ViewContainerRef), ɵɵdirectiveInject(TemplateRef));
};
...
_BsDropdownToggleDirective.ɵfac = function BsDropdownToggleDirective_Factory(ɵt) {
  return new (ɵt || _BsDropdownToggleDirective)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(BsDropdownDirective), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(BsDropdownState));
};
...
_BsDropdownModule.ɵfac = function BsDropdownModule_Factory(ɵt) {
  return new (ɵt || _BsDropdownModule)();
};
